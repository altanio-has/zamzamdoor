...
export const categories: { slug: ProductCategory; title: string; tagline: string; icon: string; description: string }[] = [
  {
    ...
    icon: "🚪",
    description: "Full range of automatic door systems — sliding, swinging, and revolving — supplied, installed, and maintained for commercial and residential entrances across UAE and GCC.",
  },
  {
    slug: "garage-doors",
    title: "Garage Doors",
...
export const products: { icon: string; title: string; desc: string; category: ProductCategory }[] = [
  ...
  { icon: "🚪", title: "Automatic Swinging Doors", desc: "Wide selection including folding door options, custom finishes, and retrofitting services.", category: "automatic-doors" },
